    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelFeatureEntities", x => new { x.HotelId, x.FeatureId });
                    table.ForeignKey(
                        name: "FK_HotelFeatureEntities_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelFeatureEntities_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelFeatureEntities_FeatureId",
                table: "HotelFeatureEntities",
                column: "FeatureId");
